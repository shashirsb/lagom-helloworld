package org.oracle.helloworldstream.api;
...
/**
 * The helloworld stream interface.
 * <p>
 * This describes everything that Lagom needs to know about how to serve and
 * consume the HelloworldStreamService service.
 */
public interface HelloworldStreamService extends Service {
    /**
    ...
    default Descriptor descriptor() {
        return named("helloworld-stream")
                .withCalls(
